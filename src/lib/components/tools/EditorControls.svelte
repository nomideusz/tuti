...
<div class="fixed top-0 left-0 right-0 z-10 sm:py-4 sm:px-4">
  <div
    class="max-w-screen-lg mx-auto px-2 backdrop-blur-sm bg-white text-primary bg-opacity-95 border-b border-t sm:border sm:rounded-full border-gray-100 shadow"
  >
    <div>
